...
public class FFEquipmentSlotController {
    ...
    public List<Resource<FFEquipmentSlotEntity>> save(
            @RequestBody
            final List<FFEquipmentSlotEntity> entities) {
        List<Resource<FFEquipmentSlotEntity>> resources =
                new ArrayList<Resource<FFEquipmentSlotEntity>>();
    ...
    private void setIdFromRepository(final FFEquipmentSlotEntity entity) {
        ...
        try {
            ...
            try {
                ...
                System.out.println(
                        "Cannot get Entity FFEquipmentSlotEntity from Repository by name");
            }
            if (method != null
                    && field != null) {
            ...
            if (old == null
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
                    System.out.println(
                            "Cannot get Entity FFEquipmentSlotEntity from Repository by code");
                }
                if (method != null
                        && field != null) {
                    field.setAccessible(true);
            ...
            System.out.println(
                    "Cannot get Entity FFEquipmentSlotEntity from Repository by name or code");
        }
        if (old != null
                && old.size() == 1) {
