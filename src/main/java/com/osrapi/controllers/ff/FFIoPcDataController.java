    ...
    private void setIdFromRepository(final FFIoPcDataEntity entity) {
        ...
        try {
            ...
            try {
                ...
                System.out.println(
                        "Cannot get Entity FFIoPcDataEntity from Repository by name");
            }
            if (method != null
                    && field != null) {
                field.setAccessible(true);
            ...
            if (old == null
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
                    System.out.println(
                            "Cannot get Entity FFIoPcDataEntity from Repository by code");
                }
                if (method != null
                        && field != null) {
                    field.setAccessible(true);
            ...
            field = null;
                ...
                | InvocationTargetException e) {
            System.out.println(
                    "Cannot get Entity FFIoPcDataEntity from Repository by name or code");
        }
        if (old != null
                && old.size() == 1) {
