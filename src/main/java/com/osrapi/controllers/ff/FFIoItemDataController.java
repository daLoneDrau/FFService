            ...
            for (int i = entity.getGroups().size() - 1; i >= 0; i--) {
                ...
                try {
                    ...
                    try {
                        ...
                        System.out.println(
                                "Cannot get embedded lookup Entity FFGroupEntity from Controller by name");
                    }
                    Field field = null;
                    try {
                        ...
                        System.out.println(
                                "Cannot get embedded lookup Entity FFGroupEntity from class by name");
                    }
                    if (method != null
                            && field != null) {
                    ...
                    if (list == null) {
                        try {
                            ...
                            System.out.println(
                                    "Cannot get embedded lookup Entity FFGroupEntity from Controller by code");
                        }
                        try {
                            ...
                            System.out.println(
                                    "Cannot get embedded lookup Entity FFGroupEntity from class by code");
                        }
                        if (method != null
                                && field != null) {
                            field.setAccessible(true);
                    ...
                    System.out.println(
                            "CANNOT get embedded lookup Entity FFGroupEntity by name or code");
                }
                if (list != null
                        && !list.isEmpty()) {
            ...
            for (int i = entity.getTypes().size() - 1; i >= 0; i--) {
                ...
                try {
                    ...
                    try {
                        ...
                        System.out.println(
                                "Cannot get embedded lookup Entity FFObjectTypeEntity from Controller by name");
                    }
                    Field field = null;
                    try {
                        ...
                        System.out.println(
                                "Cannot get embedded lookup Entity FFObjectTypeEntity from class by name");
                    }
                    if (method != null
                            && field != null) {
                        field.setAccessible(true);
                    ...
                    if (list == null) {
                        try {
                            ...
                            System.out.println(
                                    "Cannot get embedded lookup Entity FFObjectTypeEntity from Controller by code");
                        }
                        try {
                            ...
                            System.out.println(
                                    "Cannot get embedded lookup Entity FFObjectTypeEntity from class by code");
                        }
                        if (method != null
                                && field != null) {
                            field.setAccessible(true);
                    ...
                    field = null;
                        ...
                        | InvocationTargetException e) {
                    System.out.println(
                            "CANNOT get embedded lookup Entity FFObjectTypeEntity by name or code");
                }
                if (list != null
                        && !list.isEmpty()) {
    ...
    private void setIdFromRepository(final FFIoItemDataEntity entity) {
        ...
        try {
            ...
            try {
                ...
                System.out.println(
                        "Cannot get Entity FFIoItemDataEntity from Repository by name");
            }
            if (method != null
                    && field != null) {
                field.setAccessible(true);
            ...
            if (old == null
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
                    System.out.println(
                            "Cannot get Entity FFIoItemDataEntity from Repository by code");
                }
                if (method != null
                        && field != null) {
                    field.setAccessible(true);
            ...
            field = null;
                ...
                | InvocationTargetException e) {
            System.out.println(
                    "Cannot get Entity FFIoItemDataEntity from Repository by name or code");
        }
        if (old != null
                && old.size() == 1) {
