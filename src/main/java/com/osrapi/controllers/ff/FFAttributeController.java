...
public class FFAttributeController {
    ...
    private void setElementIdFromRepository(
        ...
        try {
            ...
            Field field = null;
            try {
                method = FFEquipmentElementTypeController.class
                        .getDeclaredMethod(
            ...
            if (method != null
                ...
                if (field.get(entity.getElement()) != null) {
                    list = (List<Resource<FFEquipmentElementTypeEntity>>) method
                            .invoke(
                                    FFEquipmentElementTypeController
                                            .getInstance(),
                                    (String) field
            ...
            if (list == null) {
                ...
                if (method != null
                    ...
                    if (field.get(entity.getElement()) != null) {
                        list = (List<
                                Resource<FFEquipmentElementTypeEntity>>) method
                                        .invoke(FFEquipmentElementTypeController
                                                .getInstance(),
                                                (String) field.get(
                                                        entity.getElement()));
                    }
        ...
        if (memberEntity == null) {
            memberEntity =
                    (FFEquipmentElementTypeEntity) ((Resource) FFEquipmentElementTypeController
                            .getInstance().save(
                                    entity.getElement())
                            .get(0)).getContent();
        }
    ...
    private void setIdFromRepository(final FFAttributeEntity entity) {
        ...
        try {
            ...
            try {
                ...
                System.out.println(
                        "Cannot get Entity FFAttributeEntity from Repository by name");
            }
            if (method != null
                    && field != null) {
                field.setAccessible(true);
            ...
            if (old == null
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
                    System.out.println(
                            "Cannot get Entity FFAttributeEntity from Repository by code");
                }
                if (method != null
                        && field != null) {
                    field.setAccessible(true);
            ...
            field = null;
                ...
                | InvocationTargetException e) {
            System.out.println(
                    "Cannot get Entity FFAttributeEntity from Repository by name or code");
        }
        if (old != null
                && old.size() == 1) {
